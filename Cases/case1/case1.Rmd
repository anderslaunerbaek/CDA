...
* `RMSE=``r RMSE_func(Y_train, Y_hat_comp)` 
...
# save model objects
save(X_tt, X_train, Y_train, Y_train_mean, r_num, beta_r, beta_las, beta_el, file="~/DTU/Courses/CDA/Cases/case1/model_objects.rda")
```
